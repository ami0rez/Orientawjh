  ...
  function add_horizon(p,id) {
    if(id==null)id=-1;
      try{
        ...
        horizon.push(y);
        document.getElementById("horizon_f").value +=";"id+","+y;
  ...
  function add_filliere(p,id) {
    if(id==null)id=-1;
      try{
        ...
        filliere.push(y);
        document.getElementById("filliere_f").value +=";"id+","+y;
    ...
    if(id==null)id=-1;
      try{
        ...
        if(p!=null)y=p;
                ...
                diplome.push(y);
                document.getElementById("diplome_f").value +=";"id+","+y;
...
<form name="myForm" method="post" action="../addch.php" >
  ...
  <input type="text" name="id_ad" value="<?php echo $_SESSION['id_admin']; ?>"/>
</div>
